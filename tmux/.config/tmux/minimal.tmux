...
# Repository
# https://github.com/niksingh710/minimal-tmux-status/blob/main/minimal.tmux
...
tmux set-option -g status-left "#[bg=default,fg=default,bold]#{?client_prefix,,${indicator}}#[bg=${bg},fg=#000000,bold]#{?client_prefix,${indicator},}"
